    ...
    <div className="space-y-5 pb-10">
      ...
      {loading ? (
        ...
        <div className={cardCls + " p-2"}>
          <EmptyState
            title={`ไม่มีคำขอย้ายสาขา${tab === "pending" ? "ที่รออนุมัติ" : ""}`}
            description={tab === "pending" ? "คำขอที่รออนุมัติทั้งหมดได้รับการดำเนินการแล้ว" : "ยังไม่มีคำขอย้ายสาขาในระบบ"}
          ...
          <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-gray-800 shadow-2xl p-6 space-y-4">
            <h3 className="flex items-center gap-2 text-lg font-bold text-gray-900 dark:text-gray-100">
              {modal.action === "approve" ? (
                <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-emerald-600 dark:text-emerald-400">
                  <path d="M20 6 9 17l-5-5" />
                </svg>
              ) : (
                <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-red-600 dark:text-red-400">
                  <path d="M18 6 6 18M6 6l12 12" />
                </svg>
              )}
