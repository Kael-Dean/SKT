          ...
          <div className="grid gap-4 md:grid-cols-6">
            ...
            <div className="flex items-end gap-2 md:col-span-6">
              <button
                onClick={fetchOrders}
                type="button"
                className="inline-flex h-10 items-center justify-center rounded-xl bg-emerald-600 px-4 font-medium text-white hover:bg-emerald-700 active:scale-[.98]"
              >
                ค้นหา
              </button>
              <button
        ...
        <div className="overflow-x-auto rounded-2xl border border-emerald-200 bg-white text-black shadow-sm">
          <table className="min-w-full text-left text-sm">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td className="px-3 py-3" colSpan={9}>กำลังโหลด...</td>
                </tr>
              ) : rows.length === 0 ? (
                <tr>
                  <td className="px-3 py-3" colSpan={9}>ไม่พบข้อมูล</td>
                </tr>
              ) : (
                rows.map((r) => (
                  <tr
