                ...
                if (r.kind === 'title' || r.kind === 'section') {
                    return (
                        <tr key={r.code} className="bg-slate-200 dark:bg-slate-700">
                          <td className="border border-slate-300 px-1 py-2 text-center font-bold text-xs dark:border-slate-600 sticky left-0 top-[52px] z-[15] bg-slate-200 dark:bg-slate-700">{r.kind==='section' ? r.code: ''}</td>
