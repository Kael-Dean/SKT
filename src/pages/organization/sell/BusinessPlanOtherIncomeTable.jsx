...
const ROWS = [
  ...
  { code: "2.1", label: "ดอกเบี้ยเงินฝากธนาคาร", kind: "item" },
  { code: "2.2", label: "ค่าธรรมเนียมแรกเข้า", kind: "item" },
  { code: "2.3", label: "ผลตอบแทนการถือหุ้น", kind: "item" },
  { code: "2.4", label: "เงินรางวัลจากการลงทุน-ทวีสิน", kind: "item" },
  { code: "2.5", label: "รายได้เงินอุดหนุนจากรัฐ", kind: "item" },
  { code: "2.6", label: "รายได้จากการรับรู้", kind: "item" },
  { code: "2.7", label: "รายได้จากการขายซองประมูล", kind: "item" },
  { code: "2.8", label: "รายได้เบ็ดเตล็ด", kind: "item" },
...
const BusinessPlanOtherIncomeTable = () => {
  ...
  const computed = useMemo(() => {
    ...
    // subtotal
    rowTotal["2.T"] = sumCodes(["2.1", "2.2", "2.3", "2.4", "2.5", "2.6", "2.7", "2.8"])

    return {
      rowTotal,
      colTotal: { hq: rowTotal["2.T"].hq, surin: rowTotal["2.T"].surin, nonnarai: rowTotal["2.T"].nonnarai },
      grand: rowTotal["2.T"].total,
    }
  ...
  const payload = useMemo(() => {
    return {
      table_code: "BUSINESS_PLAN_OTHER_INCOME",
      table_name: "รายได้อื่นๆ",
      period,
        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div className="flex-1">
            <div className="text-center md:text-left">
              <div className="text-lg font-bold">ประมาณการ รายได้อื่นๆ</div>
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-3">
              ...
              <div className="md:col-span-1">
                <label className="mb-1 block text-sm text-slate-700 dark:text-slate-300">รวม (บาท)</label>
      ...
      >
        <div className="p-2 md:p-3 shrink-0">
          <div className="flex flex-col gap-1 md:flex-row md:items-center md:justify-between">
            <div className="text-base md:text-lg font-bold">ตารางรายได้อื่นๆ (กรอกได้)</div>
