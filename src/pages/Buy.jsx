...
const useEnterNavigation = (refs, buyerType, order) => {
  ...
  const orderOrder = [
    ...
    "unitPrice","amountTHB","comment","payment","issueDate","paymentRefNo",
  ]
...
const Buy = () => {
  ...
  const refs = {
    ...
    // --- Dept (credit) --- (คงไว้แต่ไม่แสดง UI)
    ...
    <div className="min-h-screen bg-white text-black dark:bg-slate-900 dark:text-white rounded-2xl text-[15px] md:text-base">
      <div className="mx-auto max-w-7xl p-5 md:p-6 lg:p-8">
        ...
        <div className="mb-6 rounded-2xl border border-slate-200 bg-white p-5 text-black shadow-sm dark:border-slate-700 dark:bg-slate-800 dark:text-white">
          ...
          {/* วิธีชำระเงิน + วันที่ + เลขที่ใบชั่ง/ใบเบิกเงิน */}
          <div className="grid gap-4 md:grid-cols-3">
            <div>
              ...
              <ComboBox
                ...
                onEnterNext={() => { /* กด Enter แล้วไปช่องวันที่ */ focusNext("payment") }}
              />
            </div>
